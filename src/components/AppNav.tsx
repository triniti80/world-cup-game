      ...
      {TABS.map((tab) => {
        ...
        return (
          <Link
            ...
            href={tab.href}
            className={
              ("mobileHidden" in tab && tab.mobileHidden ? "hidden md:inline-flex " : "inline-flex ") +
              "min-w-fit shrink-0 items-center justify-center rounded-lg px-3 py-2 text-center font-semibold transition active:scale-95 md:px-3 md:py-1.5 " +
              (active
